...
MyVec<T> & MyVec<T>::operator=(const MyVec<T> &other) {
	...
	destroy(); //Exercicio: por que precisamos disso? Precisamos fazer isso para desalocar a memoria
	dataCapacity = other.dataCapacity;
	dataSize = other.dataSize;
	//data = other.data; //por que nao podemos fazer isso? Porque dois ponteiros apontariam para o mesmo vetor (double free)
...
// O pior caso é quando todos os elementos são iguais ao que você quer deletar
// Com isso, a ordem de complexidade seria O(n²) sendo n o tamanho do vetor
// É possível melhorar alocando um vetor auxiliar, porém gastaria mais memória
template<class T>
